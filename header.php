...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="images/1607398563shopping-logo.png">
            ...
            <div class="col-md-2">
                <?php
                    if(!empty($header[0]['site_logo'])){ ?>
                        <a href="<?php echo $hostname; ?>" class="logo-img"><img src="images/1607348871shopping-logo.png" alt=""></a>
