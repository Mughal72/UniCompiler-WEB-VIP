    ...
    <div class="admin-content-container">
        ...
        <form id="createProduct" class="add-post-form row" method="post" enctype="multipart/form-data">
            <div class="col-md-9">
                ...
                <label for="" style="color: white; font-size: 17px">Product Title</label>
                    <input type="text" class="form-control product_title" name="product_title" placeholder="Product Title" requried/>
                </div>
                <div class="form-group category">
                    <label for="" style="color: white; font-size: 17px">Product Category</label>
                    <?php
                    $db = new Database();
                ...
                <div class="form-group sub_category">
                    <label for="" style="color: white; font-size: 17px">Product Sub-Category</label>
                ...
                <div class="form-group brand">
                    <label for="" style="color: white; font-size: 17px">Product Brand</label>
                ...
                <div class="form-group">
                    <label for="" style="color: white; font-size: 17px">Product Description</label>
